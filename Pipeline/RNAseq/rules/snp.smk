rule samtools_mpileup:
        ...
        output:"outData/snp/{sample}.samtools.vcf"
        params:config["ref"]["fasta"]
        threads:config["threads"]
        shell:"""
			samtools mpileup -t AD,ADF,ADR,DP,SP -ugf {params} {input} | bcftools call -vm  > {output}
...
rule GATK_SelectVariants:
	    ...
	    refName=params[1][:-3]
            ...
            if os.path.isfile("%s.dict" % (refName))== False:
                shell(cmd1)
